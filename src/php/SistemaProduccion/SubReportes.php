                    ...
                    case 'RCompraInumos':
                        switch($_GET['tipo']) {
                            ...
                            case 'Preconsulta':
                                $ventas=$this->conexion->RCompraInumos($_GET['FI'],$_GET['FF']);
                                foreach( $ventas as $row) { 
                                    $datos[] = array($row[1],$row[2],$row[3],$row[4],$row[5],$row[6], $row[7],$row[8],$row[9] );
                                }
                    ...
                    case 'RCompraInumosProveedor':
                        switch($_GET['tipo']) {
                            ...
                            case 'EXCEL':
                                ...
                                case 'Preconsulta':
                                    $Resultado=$this->conexion->RCompraInumosProveedor($_GET['id'],$_GET['FI'],$_GET['FF']);
                                    echo json_encode($Resultado["detalles"]);
                                    break;
                            }
                    ...
                    case 'RInusmosClasificacion':
                        switch($_GET['tipo']) {
                            ...
                            case 'Preconsulta':
                                ...
                                foreach ($detalles as $row) {
                                    $fila = array($row['nombre'], $row["descripcion"], $row["unidad"], $row["existencias"], $row["maximo"], $row["minimo"], $row["costoPromedio"]);
                                    array_push($detalles_final, $fila);
                                }
                                echo json_encode($detalles_final);
                            break;
                        }
                    ...
                    case 'ROrdenProduccion':
                        switch($_GET['tipo']) {
                            case 'PDF':
                                ...
                                case 'Preconsulta':
                                    $Resultado=$this->conexion->ROrdenProduccion($_GET['FI'],$_GET['FF']);
                                    $ordenesProduccion = array();
                                    foreach($Resultado as $row){ 
                                        if($row[10]=="Terminado"){
                                            $ordenesProduccion[] = array($row[0],$row[1],$row[2],$row[3],$row[4],$row[5],$row[6],$row[7],$row[8],$row[9],$row[10]);
                                        } else {
                                            $ordenesProduccion[] = array($row[0],$row[1],$row[2],$row[3],$row[4],$row[5],$row[6],"---","---","---",$row[10]);
                                        }
                                    }
                                    echo json_encode($ordenesProduccion);
                                    break;
                            }
                    break;  
                        ...
                        switch($_GET['tipo']) {
                            case 'PDF':
                                ...
                                case 'Preconsulta':
                                        ...
                                        if($_GET['Estado']=="Terminado"){
                                            foreach( $Resultado as $row){ 
                                                $ordenesProduccion[]= array( $row[0],$row[1],$row[2],$row[3],$row[4],$row[5],$row[6],$row[7],$row[8],$row[9]);
                                            }
                                        }else{
                                            foreach( $Resultado as $row){ 
                                                $ordenesProduccion[]= array(  $row[0],$row[1],$row[2],$row[3],$row[4],$row[5],$row[6]);
                                            }
                                        }
                                        echo json_encode($ordenesProduccion);
                                break;
                        ...
                        switch($_GET['tipo']) {
                            case 'PDF':
                                    ...
                                    case 'Preconsulta':
                                        ...
                                        foreach ($Resultado["detalles"] as $row) {
                                            $resultadoFinal[] = [$row["idVale"], $row["fecha"],  $row["responsable"], $row["nombre"], $row["cantidad"]];
                                        }
                        ...
                        switch($_GET['tipo']) {
                            ...
                            if(count($Resultado)!=0){ 
                                ...
                                case 'Preconsulta':
                                    ...
                                    foreach ($Resultado as $row) {
                                        $resultadoFinal[] =   [$row["idOrden"],$row["descripcion"],$row["idVale"],$row["fecha"],$row["responsable"],$row["nombre"],$row["cantidad"]];
                                    }
                        ...
                        switch($_GET['tipo']) {
                            case 'PDF':
                                ...
                                case 'Preconsulta':
                                    ...
                                    foreach ($Resultado as $row) {
                                        $resultadoFinal[] =  [$row["idDevolucion"],$row["fecha"],$row["responsable"],$row["nombre"],$row["cantidad"]];
                                    }
                        ...
                        switch($_GET['tipo']) {
                            ...
                            case 'EXCEL':         
                                ...
                                case 'Preconsulta':
                                    ...
                                    foreach ($Resultado as $row) {
                                        $resultadoFinal[] =  [$row["idOrden"],$row["descripcion"],$row["idDevolucion"],$row["fecha"],$row["responsable"],$row["nombre"],$row["cantidad"]];
                                    }
                    ...
                    case 'RMerma':
                        switch($_GET['tipo']) {
                            ...
                            case 'Preconsulta':
                                ...
                                foreach ($Resultado as $row) {
                                    $resultadoFinal[] =  [$row["fecha"],$row["nombre"],$row["nombre"],$row["cantidad"],$row["motivo"]];
                                }
