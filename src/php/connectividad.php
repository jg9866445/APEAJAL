    ...
    public function connect() 
    {
        try {
            if($this->debug){
                ...
                $this->connection = new PDO('mysql:host=localhost;dbname=u517350403_apeajalvivero', 'u517350403_apeajalvivero', 'S|1#q&5Jt9/', [PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8"]);
            }
